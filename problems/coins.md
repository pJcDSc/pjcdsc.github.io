...
Show that if any $$ p_i=0.5 $$, then the probability that you have an odd number of heads is equal to the probability
that you have an even number of heads.
